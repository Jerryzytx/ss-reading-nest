...
describe("registerReadingResource", () => {
  it("keeps current and legacy component URIs available with compatible CSP metadata", async () => {
    ...
    expect(READING_NEST_URI).toBe(
      "ui://ss-reading-nest/app-v83-native-inline.html"
    );
    ...
    expect(uri).toBe("ui://ss-reading-nest/app-v83-native-inline.html");
    ...
    expect(probe.contents[0].text).toContain("鼠兔和家机的书屋 App 组件已显示");
